  ...
  MIDI.audioDetect(function(types) {
    ...
    switch (type) {
      case "#java":
        ...
        if(typeof($) != 'undefined'){
            $('.midi-player').removeClass('is-hidden');
        }
        break;
      case "#flash":
      ...
      case "#webaudio":
        ...
        MIDI.volume_scheme = 'chrome'
        DOMLoader.sendRequest({
          //url: "./soundfont/soundfont-" + filetype + instrument + ".js",
          url: MIDI.soundfont_mp3_url,
          callback: function(response) {
            MIDI.Soundfont = JSON.parse(response.responseText);
            if (loader){
                loader.message("Downloading: 100%<br>Processing...");
            }
