...
I18n.translations["en"] = I18n.extend((I18n.translations["en"] || {}), {
	...
	"activerecord": {
		"attributes": {
			...
			"europeana/record/set": {
				"settings_query_term": "Query term"
			},
			"gallery": {
				"image_portal_urls_text": "Item URLs on the portal",
				"topic_ids": "Topics"
			},
			"hero_image": {
				"settings_attribution_creator": "Attribution creator",
				"settings_attribution_institution": "Attribution institution",
				"settings_attribution_text": "Attribution text",
				"settings_attribution_title": "Attribution title",
				"settings_attribution_url": "Attribution URL",
				"settings_brand_colour": "Brand colour",
				"settings_brand_opacity": "Brand opacity",
				"settings_brand_position": "Brand position",
				"settings_ripple_width": "Ripple width"
			},
			"link/promotion": {
				"settings_category": "Category",
				"settings_class": "CSS class",
				"settings_wide": "Wide?"
			},
			"page": {
			...
			"user": {
				"permissionable_browse_entry_ids": "Permissions on Browse Entry Points",
				"permissionable_feed_ids": "Permissions on What's Happening Feeds",
				"permissionable_gallery_ids": "Permissions on Galleries",
				"permissionable_landing_page_ids": "Permissions on Landing Pages"
			}
		},
		"errors": {
			"messages": {
		...
		"models": {
			"page/browse/record_sets": {
				"one": "Record Sets Browse Page",
				"other": "Record Sets Browse Pages"
			},
			"page/error": {
				"one": "Error Page",
				"other": "Error Pages"
	...
	"admin": {
		"actions": {
			...
			"publish": {
				"breadcrumb": "Publish",
				"done": "published",
				"link": "Publish '%{object_label}'",
				"menu": "Publish",
				"title": "Publish %{model_label} '%{object_label}'"
			},
			"requeue": {
				"breadcrumb": "Requeue",
				"done": "requeued",
		...
		"help": {
			"browse_entry": {
				"query": "Include everything after the ? in a search URL, e.g. \"q=paris\u0026f[TYPE][]=IMAGE\". Do not include page or per_page."
			},
			"europeana/record/set": {
				"settings_query_term": "Optional. Search query term for this set. If omitted, preferred label will be used."
			},
			"gallery": {
				"image_portal_urls_text": "Enter 6-48 URLs to record pages on Europeana, separated by any amount of white space. The edm:isShownBy for the record will be used for that image, unless a web resource is specified with `?view=...`. Change the URL order to change the position of an image in the gallery."
			},
			"page/browse/record_sets": {
				"base_query": "Optional. Portal search query for all record sets on this page, used for \"more records\" links, combined with set query, e.g. \"f[TYPE][]=IMAGE\".",
				"link_text": "Optional. Customise the link text shown to search for more records in each set. Include \"%%{set_pref_label}\" where the set preferred label should go, e.g. \"More records like %%{set_pref_label}...\".",
				"set_query": "Optional. Portal search query for each record set on this page, used for \"more records\" links. Include \"%%{set_query_term}\" where the set-specific query term should go, e.g. \"q=proxy_dc_title:%%{set_query_term}*\"."
			},
			"page/landing": {
				"strapline": "Include \"%%{total_item_count}\" where the number of items should be displayed."
			}
		},
		"home": {
			"name": "Home"
	...
	"attributes": {
		"alt_label_text": "Alternative label",
		"portal_urls_text": "Portal URLs",
	...
	"blacklight": {
		...
		"search": {
			...
			"facets": {
				...
				"count": "%{number}",
				"missing": "[Missing]",
				"more_html": "more \u003cspan class=\"sr-only\"\u003e%{field_name}\u003c/span\u003e Â»",
				"selected": {
					"remove": "[remove]"
				},
				"sort": {
	...
	"contribute": {
      ...
      "generic": {
			...
			"migration": {
				"form": {
					"buttons": {
						...
						"topic": {
							"add": "Add another topic",
							"remove": "Remove this topic"
						}
					},
					"hints": {
						"defaults": {
							"dc_creator": "For example: Who took this photograph, or who wrote this recipe? If you do not know, leave this blank.",
						...
						"edm_aggregatedCHO": {
							...
							"dc_subject": "Choose a keyword to help people find this story. Once you start typing, weâ€™ll show you suggestions from which you can choose."
						},
						"edm_hasView": {
							"media": "The content must be an image, audio, video or PDF."
						},
						"edm_isShownBy": {
							"media": "The content must be an image, audio, video or PDF."
						}
					...
					"js_required": "We do not allow submissions without Javascript enabled, please enable Javascript in your browser in order to submit this form",
					"labels": {
						"contribution": {
						...
						"defaults": {
							...
							"dc_description": "Give your object a title",
							...
							"edm_rights_id": "Please select the most appropriate option for your object. \n",
						...
						"edm_aggregatedCHO": {
							...
							"dc_subject": "What topics or themes does this story cover?",
							"dc_subject_agents": {
						...
						"edm_web_resource": {
							"edm_rights": {
								...
								"rightsstatements_org": {
									"vocab": {
										"CNE": {
											"1_0": "Copyright Not Evaluated\nI donâ€™t know who created this object or I do not have explicit permission to share it\nThis means:\nThe copyright in this object has not been evaluated.\nAnyone using the object must undertake their own due diligence."
										}
									}
								}
							}
					...
					"placeholders": {
						...
						"edm_aggregatedCHO": {
							"dc_description": "For example: â€˜My grandfather migrated back to the Netherlands from the Dutch East Indies (modern Indonesia) after the Second World War. They survived and returned to the Netherlands along with this money box which still reminds us of my familyâ€™s life in the Indies.â€™",
							"dc_title": "For example: My grandfatherâ€™s money box. My great auntâ€™s watch.",
							"dcterms_spatial": "For example: Rome, Italy"
						}
					},
					"validation": {
						...
						"web-resource-license": "Please choose one of the above licenses"
					}
				},
				"pages": {
					"create": {
					...
					"index": {
						...
						"description": "Sharing your migration history can help us to tell a really big story - the story of Europe and the people who live here. Your story is part of Europeâ€™s rich and shared history of migration, and now it can be recorded for the future.",
						"hero": {
							"attribution_institution": "Gooi en Vecht Historisch",
							"attribution_text": "A family with 10 children are going to emigrate",
							"subtitle": "We all have objects - like pictures, letters, postcards or recipes - to share and stories to tell about where we've come from and what's shaped our lives.  For many of us, that involves our personal, family or community's stories of migration and immigration.",
							"title": "Share your migration story"
						},
						"preview_1": {
							"caption": "Avfotografert postkort som ble sendt fra emigrerte vadsÃ¸vÃ¦ringer i USA til slekt og venner i Norge. Finnmark Fylkesbibliotek. Public Domain",
							"text": "These objects are important parts of your heritage and recording and digitising them is easier than you might think.  Once it's done, they will become part of the European Migration Collection and made freely available for anyone to discover and use for education, research, inspiration and pleasure."
						},
						"preview_2": {
							"caption": "Rectangular tobacco box with image of steamship \"Rotterdam\", Museum Rotterdam, 1920-1930, CC BY",
							"text": "Europeâ€™s collective story involves movement and mixing, and as much happiness, love and life as there is sadness, war and tragedy. "
						},
						"preview_3": {
							"button_text": "Read more about Marijke's story",
							"caption": "Marijke's Photo | Europeana.  Public Domain",
							"text": "'For an international day at my school in Senegal when I was about 6, my mother dressed my brother like the Ghanaian flag - she was from Ghana - and me like the Dutch flag - my father is Dutch.'"
						},
						"preview_4": {
							"button_text": "Info",
							"caption": "A family with 10 children are going to emigrate,\u003cbr\u003e\nGooi en Vecht Historisch",
							"text": "Throughout 2018, the European Year of Cultural Heritage, Europeana will run a series of collection days and events involving museums, libraries, archives and audiovisual collections across Europe."
						},
						"title": "Share your migration story"
					},
					"new": {
		...
		"contributions": {
			"confirm": {
				"delete": "Are you sure you want to permanently remove the contribution?",
				"delete_1": "Deletion is irreversible!",
				"delete_2": "Are you sure you want to permanently remove the contribution?"
			},
			"events": {
				"publish": "Publish",
				"unpublish": "Unpublish",
			...
			"notices": {
				"delete_error": "Unable to delete: %{name}.",
		...
		"form": {
			...
			"validation": {
				"media_size": "Please ensure each uploaded file is no more than %{size}"
			},
			"warnings": {
				"delete": "Deletion is irreversible!"
			}
		},
		"helpers": {
			"submit": {
	...
	"en": {
		"site": {
			"browse": {
				"newcontent": {
					"description": "Here, you can explore all the recent additions to Europeana Collections. See which cultural institution has contributed new items, the number of items they've added and when. Just click on the links below to find out more. "
				},
				"sources": {
					"description": "Below you see a list of institutions who have contributed their content to Europeana Collections. These institutions aggregate and contribute their data to Europeana, click on the link that interests you below to view a particular partner collection!"
				}
			}
		}
	},
	...
	"global": {
      ...
      "copy-attribution": "Show your appreciation. Copy to attribute.",
		...
		"feedback": {
			...
			"error": "Error",
			"open": "Feedback",
			"placeholder": "Let us know what you think and what we can improve. If you want to be contacted, please leave your email address here too!",
			"submit": "Submit",
			"thanks": {
    ...
    "mission": "We transform the world with culture! We want to build on Europeâ€™s rich heritage and make it easier for people to use, whether for work, for learning or just for fun.",
		...
		"navigation": {
			"agents": "People",
			"all_blog_posts": "All blog postsâ€¦",
			"all_exhibitions": "All exhibitionsâ€¦",
			"all_galleries": "All galleries...",
			"blog": "Blog",
			"browse": "Explore",
			"browse_colours": "Colours",
			"browse_newcontent": "What's new?",
			...
			"periods": "Time periods",
			"places": "Places",
			"view-collection": "View entire collection",
			"view-detailed-description": "View more detailed description"
		},
		"newsletter": {
    ...
    "other-formats": "other formats",
		...
		"search-collections-text": "Explore Europeâ€™s cultural heritage",
		"settings": "Settings",
		"share": "Share",
		"sitemap": "Sitemap",
		"subscribe": "Subscribe",
	...
	"site": {
		"alpha": {
			"feedback_banner": {
				"description": "A Beta release means that this website is in active development and will be updated regularly. It may sometimes be offline. Your feedback will help us improve our site.",
				"link-text": "Give us your input!",
				"title": "This is a Beta release of our new \"Collections\" and \"Music Collections\""
			}
		},
		...
		"blogs": {
			"description": "Blogs",
			"list": {
				"count-and-terms-with-range": "%{results_range} of %{results_count} blog posts",
				"page-title": "Blog"
			},
			"min-to-read": "minutes to read"
		},
		"browse": {
			"colours": {
				"description": "Search for images based on their colour. Simply click a coloured box below to discover images containing that colour!",
				"title": "Colours"
			},
			"newcontent": {
				"description": "Here, you can explore all the recent additions to Europeana Collections. See which cultural institution has contributed new items, the number of items they've added and when. Just click on the links below to find out more. ",
				"tableh1": "All institutions",
				"tableh2": "Items",
				"tableh3": "Date",
				"title": "What's new?"
			},
			"people": {
				"description": "Here you can find highlights from Europeana Collections relating to the lives and works of famous artists, composers and other important figures from history.",
				"title": "People"
			},
			"periods": {
				"description": "Browse by time period.",
				"title": "Time Periods"
			},
			"sources": {
				"description": "Below you see a list of institutions who have contributed their content to Europeana Collections. These institutions aggregate and contribute their data to Europeana, click on the link that interests you below to view a particular partner collection!",
			...
			"topics": {
				"description": "Explore Europeana Collections by topic, theme or genre.",
				"title": "Topics"
			}
		},
		"collections": {
			"art-history": {
				"description": "From the Renaissance to the surrealists, and from ancient Roman sculpture to contemporary art, Europeana Art introduces you to artists and artworks from across Europe.",
			...
			"description": "Europeana Thematic Collections expose content related to specific topics.",
			"e7a1418": {
				"contribute": "Add your 1914-1918 story",
			...
			"labels": {
				...
				"sneak-peek": "Explore Europeana Fashion",
				"sneak-peek-collection": "Explore \u003ci\u003e%{preview_title}\u003c/i\u003e on %{collection}",
				"spotlight-on": "Spotlight on ",
				"whats-happening": "What's happening"
			},
			"music": {
				"description": "The \u003cstrong\u003eEuropeana Music Collection\u003c/strong\u003e brings together the best music recordings, sheet music, and other music related collections from Europe's audio-visual archives, libraries, archives and museums. \u003ca href=\"/portal/channels/music/about\"\u003eFind out more about the Music Collection.\u003c/a\u003e",
		...
		"entities": {
			...
			"tab_items": {
				"items_about": "Items about %{name}",
				"items_by": "Items by %{name}"
			},
			"types": {
				"agent": "Person",
				"concept": "Concept",
			...
			"wiki_link_text": "Resource obtained from Wikimedia Commons"
		},
		"events": {
			"all_day": "All Day",
			"description": "Events",
			"list": {
				"count-and-terms-with-range": "%{results_range} of %{results_count} events",
		...
		"footer": {
			"menu": {
				"about": "About",
				"become-a-provider": "Become our partner",
				"contact": "Contact",
				"contact-us": "Contact us",
				"copyright": "Copyright",
				"data-providers": "All institutions",
				"help": "Help",
				"new-collections": "New collections",
				"rights": "Terms of use \u0026 Policies",
		...
		"galleries": {
			"description": "Culture curated for you! Discover Europeana Galleries!",
			"description-default": "Find out more on Europeana",
			"share": {
				"one": "Share this gallery",
				"other": "Share the galleries"
			}
		},
		"helpbar-tip": {
			"browse-page": "Tip: hover over image for more options",
			"item-page": "We want your feedback on our new item page, use our feedback button to leave your comments."
		},
		"more": "More...",
		"my-europeana": "MyEuropeana",
		"my-europeana-link": "link to My Europeana",
		"name": "Europeana Collections",
		"navigation": {
			"breadcrumb": {
				"account": "account",
				"blogs_list_breadcrumb": "Blog",
				"contribution": "Contribution",
				"contribution-attachment": "Attachment",
				"contribution-attachments": "Attachments",
				"contribution-done": "done",
				"contributor": "Contributor",
				"events_list_breadcrumb": "Events",
				"exhibitions": {
					"return_home": "Exhibitions"
				},
				"item_detail": "Item",
				"register": "Register",
				"reset-password": "Reset Password",
				"results_list": "Results",
				"results_list_mlt": "Similar items",
				"return_home": "Return to Home",
				"sign-in": "Sign In"
			},
			"search": {
				"placeholder": {
					"text": "Search by keyword here"
				}
			}
		},
		"news": "News",
		"notice": {
			"outage-expected": "Europeana Collections may experience service outages between 19:00 (CET) and 01:00 (CET) due to ongoing maintenance by our hosting provider. We appreciate your patience during this time."
		},
		"object": {
			"actions": {
				"annotate": "Annotate",
				"attribute-author": "Attribute the author",
				"attribute-html": "HTML",
				"attribute-plaintext": "Plain text",
				"collapse-extended": "collapse extended information",
				"download": "Download",
				"download-additional": "Also available as",
				"download-retry": "Retry",
				"download-started": "The download has started",
				"downloaddata": "Download data",
				"enlarge": "Enlarge",
				"expand-extended": "expand extended information",
				"explore-by-colour": "Explore by colour",
				"media-metadata": "Media Metadata",
				"open-media": "Open this media item",
      ...
      "main-img-alt": "Image from object titled",
			"promotions": {
				"card-labels": {
					...
					"dcCreator": "The creator of this object"
				}
			},
			"description_unavailable": "Sorry.  No description is available.",
			"enrichment": {
				"who": {
					"title": "Title"
				}
			...
			"hierarchy": {
				"title": "Related items",
				"view-items-above": "view items above",
				"view-items-below": "view items below"
			},
			"meta-label": {
				"additional-rights": "Additional rights information",
				...
				"edm": {
					"has-met": "Is related to",
					"incorporates": "Incorporates",
					"is-derivative-of": "Is derivative of",
					"is-representation-of": "Is representation of",
					"is-similar-to": "Is similar to",
					"is-successor-of": "Is successor of",
					"realises": "Realises",
					"was-present-at": "Present at"
				},
				"extent": "Size",
				"file-size": "File size",
				"format": "Format",
				...
				"intermediate-provider": "Intermediate provider",
				...
				"provided-by": "Find out more",
				"provided-by-detail": "View at %{institution_name_and_link}",
				"provided-by-detail-no-link": "Europeana is displaying this item via",
				"provider": "Provider",
				...
				"runtime": "Run time",
				"runtime-unit-seconds": "seconds",
				"source": "Source",
				"subject": "Subject",
				"temporal": "Temporal",
				"time": "Time",
				"timestamp-created": "First published in Europeana",
				"timestamp-updated": "Last updated in Europeana",
			...
			"named-entities": {
				...
				"what": {
					...
					"label": "Concept Label",
					"term": "Concept Term",
					"title": "Subjects, resource types, genres and forms (Concepts)"
				},
				"when": {
					"begin": "Period Begin",
					"end": "Period End",
					"label": "Period Label",
					"term": "Period Term",
					"title": "Time spans and dates (TimeSpan)"
				},
				"where": {
					"label": "Place Label",
					"latitude": "Latitude",
					"longitude": "Longitude",
					"term": "Place Term",
					"title": "Place names (Places)"
				},
				"who": {
					"label": "Agent Label",
					"term": "Agent Term",
					"title": "Persons and organisations (Agents)"
				}
			},
			"nav": {
				"next": "Next",
			...
			"preview_unavailable": "Item preview not available, to access the full image and more information about the item go to %{institution_name_and_link}",
			"preview_unavailable_explanation": "This link will take you to",
			"preview_unavailable_intro": "No preview was provided by our partners, more information may be available at the source.",
			"preview_unavailable_source": "Go to source",
			"previous-item": "Previous item",
			"show-more-similar-items": "show more",
			"similar-items": "Similar items",
			"title_unavailable": "Sorry.  No title is available."
		},
		"pages": {
			"404": {
				"intro": "Sorry, we can't find that page",
				"text": "Unfortunately we couldn't find the page you were looking for. Try searching Europeana or you might like the selected items below."
			},
			"about": {
				"text": "\u003cp\u003eSearching for a favourite old painting? Doing some research or writing a school paper?  Looking for an inspiration for your next coffee mug design?  Fancy learning something new? Whatever the reason for your visit to Europeana, welcome!\u003c/p\u003e\n\n\u003cp\u003eDelve into Europe's largest online collection of art, culture and science. Europeana Collections brings you material from the famous and the not-so-famous (but always fascinating)  libraries, museums, galleries and archives of Europe.\u003c/p\u003e\n\n\u003cp\u003eBooks and manuscripts, photos and paintings, sculpture and sheet music, videos and sound recordings, diaries and maps - theyâ€™re all here. No need to travel the continent, either physically or virtually!\u003c/p\u003e\n\n\u003cp\u003eExplore, discover, watch, listen, read, download... Enjoy!\u003c/p\u003e\n\n\u003cp\u003eNow why not try out the \u003ca href=\"http://europeana.eu/portal/collections/art-history\"\u003eEuropeana Art History Collections\u003c/a\u003e or \u003ca href=\"http://europeana.eu/portal/collections/music\"\u003eEuropeana Music Collections\u003c/a\u003e? We also have custom resources for \u003ca href=\"http://research.europeana.eu/\"\u003eresearchers\u003c/a\u003e and cultural \u003ca href=\"http://labs.europeana.eu/\"\u003edevelopers/innovators\u003c/a\u003e (this is where you can find our \u003ca href=\"http://labs.europeana.eu/api\"\u003eAPIs\u003c/a\u003e), as well as a range of \u003ca href=\"http://exhibitions.europeana.eu/\"\u003evirtual exhibitions\u003c/a\u003e and a \u003ca href=\"http://blog.europeana.eu/\"\u003eblog\u003c/a\u003e. \u003c/p\u003e\n\n\u003cp\u003eAnd if youâ€™re still hungry for more, you can get your daily dose of culture on \u003ca href=\"https://www.facebook.com/Europeana\"\u003eFacebook\u003c/a\u003e, \u003ca href=\"https://twitter.com/Europeanaeu\"\u003eTwitter\u003c/a\u003e, \u003ca href=\"https://medium.com/@Europeana\"\u003eMedium\u003c/a\u003e, \u003ca href=\"https://plus.google.com/+europeana\"\u003eGoogle+\u003c/a\u003e, \u003ca href=\"http://europeanacollections.tumblr.com/\"\u003eTumblr\u003c/a\u003e and \u003ca href=\"https://www.pinterest.com/europeana/\"\u003ePinterest\u003c/a\u003e.\u003c/p\u003e\n\n\u003cp\u003eFor more information on how we work with cultural institutions and their collections, visit \u003ca href=\"http://pro.europeana.eu/\"\u003eEuropeana Pro\u003c/a\u003e.\u003c/p\u003e",
				"title": "Welcome, culture lover!"
			},
			"browse": {
				"record_sets": {
					"link_text": "More records like %{set_pref_label}"
				}
			},
			"music-channel-about": {
				"text": "\u003cp\u003eImagine looking at original handwritten manuscripts of a piece of music while listening to different interpretations of it, and reading a biography of the composer. On the Europeana Music Collection, you can.\u003c/p\u003e \n\n\u003cp\u003e\u003ca href=\"http://www.europeanasounds.eu\"\u003eOur partners\u003c/a\u003e, all experts in music, from across Europe have carefully curated this collection of music recordings, sheet music, images of musical instruments, books about music and other music-related content. \u003c/p\u003e\n\n\u003cp\u003eWeâ€™ve made this early test version of the Music Collection available to you, our users, so you can help us shape it as we develop it further. So when you visit the site you will at times be asked to answer questions or surveys that appear on screen. We would really appreciate if you could take the time to answer those questions and surveys!\u003c/p\u003e\n\n\u003cp\u003eAlso, in the interest of transparency and privacy, you should know that we log user statistics and user behaviour in Google Analytics and a service called Hotjar. We do that because it shows us where weâ€™ve gone wrong in our designs and so helps us to improve the Music Collection. All logs are kept private and anonymised and will only be used to improve our service.\u003c/p\u003e\n\n\u003cp\u003eWe encourage you to search the collection, play music, view the sheet music or read around it. When copyright allows, you can download the things you love most. And visit our virtual exhibitions to discover music in ways youâ€™ve never done before!\u003c/p\u003e",
				"title": "About the Music Collections"
			}
		},
		"results": {
			"actions": {
			...
			"federated": "Click here to see results from non-Europeana sources",
			"federated-clicked": "Items from non-Europeana sources",
			"federated_more": "View all %{results_count} results on %{results_provider}",
			"list": {
				"all-results": {
					"3D": "3D",
					"images": "Images",
				...
				"count-and-terms-with-range": "%{results_range} of %{results_count} results",
				"empty": "No Results",
				"empty-with-terms": "Your search for %{query_terms} returned no results",
				"header": "Results for",
				"header-and": "and",
				"in-channel": "in thematic collection",
				"less": "Less",
				"less_adv": "Less Refinements",
				"more": "More",
				"more_adv": "Advanced Filters",
				"per-page": "Per page",
				"product-3D": "3D",
				"product-image": "Image",
				"product-sound": "Sound",
		...
		"settings": {
			...
			"language": {
				"auto-translate-limit": "A maximum of %{max_languages} can be selected",
				"auto-translate-page": "Automatically translate item pages into...",
				"auto-translate-page-short": "Auto-translate items into",
				"auto-translate-query": "Automatically translate search keywords into...",
				"available": "Available languages",
				"default": "Default language",
				"flash": {
					"alert": "Invalid language specified. Available languages: %{locales}",
					"notice": "Language settings saved."
				},
				"label": "Language",
				"settings-label": "language settings"
			},
			"title": "Settings"
		},
		"ugc": {
			"actions": {
				"copy-name": "Use my name",
				"copy-public-display-name": "Use my public display name",
				"submit": "Submit"
			}
		}
	},
