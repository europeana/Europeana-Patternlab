define(['jquery', 'jqScrollto'], function() {
        ...
        */
        ...
        var brokenArrowsBottom = function(vNodes){
            ...
            if( (xNode.id != '#') && $('#' + xNode.id).hasClass('jstree-open')  ){
                ...
                var createClass  = $('#' + xNode.id).hasClass('ul') ? 'arrow bottom-ul' : 'arrow bottom';
    ...
    return {
        ...
        init : function(baseUrl, usingStartUpShortcut, debugIn){
            init((baseUrl, usingStartUpShortcut, debugIn));
        }
    }
